        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="tblsection" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>#</th>
                    <th>SECTION NAME</th>
              ...
              <div class="row">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                       <label for="name"  class="col-form-label col-form-label-sm">Section Name</label>
...
<input type="hidden" name="UID" id="UID">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                       <label for="name"  class="col-form-label col-form-label-sm">Section Name</label>
                        <input type="text" class="form-control form-control-sm" name="SECTION_NAME1"
                        id="SECTION_NAME1" placeholder="Enter Section Name" required>
                      </div>
                    </div>
