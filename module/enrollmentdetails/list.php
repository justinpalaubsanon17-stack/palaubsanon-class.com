          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of Enrollment Subjects</h3>
              </div>

              <!-- /.card-header -->
              <div class="card-body">
                <table id="tblenrollmentdetails" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>#</th>
                    <th>STUDENT NAME</th>
        ...
        <form action="controller.php?action=add" enctype="multipart/form-data" method="POST">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add Subject to Enrollment</h4>
...
<!-----START of Add Form---->
   ...
   <div class="modal fade" id="editEntry">
        ...
        <form action="controller.php?action=edit" enctype="multipart/form-data" method="POST">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Edit Enrollment Subject</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
